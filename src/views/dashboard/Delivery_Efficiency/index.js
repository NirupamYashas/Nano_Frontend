...
import { Typography, Button, Box, FormControl, InputLabel, Select, MenuItem, Slider, Collapse, Paper, Grid } from '@mui/material';
            ...
            <Box display="flex" flexDirection="column" alignItems="flex-start" marginBottom="16px">
                ...
                <Box display="flex" justifyContent="space-between" width="100%" marginBottom="16px" marginTop="16px">
                    ...
                    <FormControl variant="outlined" style={{ width: '48%' }}>
                        ...
                        <Select labelId="mat-label" id="mat" name="MAT" value={formData.MAT} onChange={handleDropdownChange} label="MAT">
                            {matOptions.map((mat) => (
